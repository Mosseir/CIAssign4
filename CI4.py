...
data = pd.read_excel("D:/Workspace Files/Intro to CI/Computer Assign 4/AirQualityUCI.xlsx", na_values=-200)
...
plt.plot(y, label="Actual", color="blue", alpha=0.5)
plt.plot(y_pred, label="Predicted", color="red", alpha=0.5)
